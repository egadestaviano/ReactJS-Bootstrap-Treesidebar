export const db = [
  ...
  },
  {
    ...
    childrens: [
      ...
      { id: 13, title: "Reset Password", path: "/reset-password" },
    ],
  },
  {
    id: 14,
    ...
    childrens: [
      { id: 15, title: "Profile", path: "/profile" },
      {
        ...
        childrens: [
          ...
          { id: 21, title: "Notifications", path: "/settings/notifications" },
        ],
      },
      { id: 22, title: "Logout", path: "/logout" },
    ],
  },
  {
    id: 23,
  ...
  { id: 26, title: "Support", icon: "bi-question-circle-fill", path: "/support" },
  { id: 27, title: "Report Bug", icon: "bi-bug", path: "/report-bug" },
];
